...
contract BetFactory is IBetFactory {
    ...
    function placeBet(address _marketAddress, string memory _marketSide, uint256 _stake, uint8 _odds, bool _instant)
        public override returns(address) 
    {
        ...
        _stableCoinWrapper.transferFrom(msg.sender, _marketAddress, _stake);
        
        Bet _bet = new Bet(msg.sender, _marketAddress, _marketSide, _stake, (_odds * 100) / (_odds - 100));
        
        _market.addBet(msg.sender, address(_bet), _stake, _odds, _marketSide, _instant);
